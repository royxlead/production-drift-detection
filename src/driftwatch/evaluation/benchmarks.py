...
class BenchmarkFramework:
    ...
    def __init__(
        ...
        self._logger = get_logger("driftwatch.benchmarks")
    ...
    def get_evidently_compatible_interface(self) -> dict:
        ...
        return {
            ...
            "differences": [
                "DriftWatch focuses on streaming detection; Evidently processes static datasets",
                "DriftWatch provides confidence-drift correlation",
            ],
            "integration_note": (
                "To compare results, run the same dataset through both "
                "Evidently's DataDriftPreset and DriftWatch's PSIDetector "
    ...
    def get_nannyml_compatible_interface(self) -> dict:
        ...
        return {
            ...
            "differences": [
                ...
                "DriftWatch adds confidence-drift correlation research module",
                "DriftWatch is designed for streaming workflows",
            ],
            "integration_note": (
                "To compare results, use NannyML's UnivariateDriftCalculator "
                "and DriftWatch's PSIDetector on the same dataset. Both support "
