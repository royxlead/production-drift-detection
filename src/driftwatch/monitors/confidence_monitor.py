...
from driftwatch.utils.stats import compute_confidence, compute_entropy, compute_margin
from driftwatch.utils.validation import validate_array, validate_probabilities
...
class ConfidenceMonitor:
    ...
    def __init__(
        ...
        self._logger = get_logger(f"driftwatch.{self.name}")
