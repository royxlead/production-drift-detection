"""HuggingFace integration adapter for DriftWatch.
...
class HFAdapter:
    """Adapter for monitoring HuggingFace transformer models with DriftWatch.
    ...
    def __init__(
        ...
        if not HF_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install driftwatch[transformers]"
            )
        ...
        self._logger = get_logger("driftwatch.hf_adapter")
