"""PyTorch integration adapter for ProductionDriftDetection.
...
class PyTorchAdapter:
    """Adapter for monitoring PyTorch models with ProductionDriftDetection.
    ...
    def __init__(
        ...
        if not TORCH_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install production_drift_detection[pytorch]"
            )
